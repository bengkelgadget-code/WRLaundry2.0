...
<template>
    <div class="flex-1 flex flex-col h-full w-full overflow-hidden relative bg-slate-50">
        ...
        <!-- Footer POS -->
        <div class="fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-md border-t border-slate-200/50 pt-3 pb-12 sm:pb-5 px-4 shadow-[0_-5px_15px_rgba(0,0,0,0.05)] z-30 flex justify-center transition-all">
